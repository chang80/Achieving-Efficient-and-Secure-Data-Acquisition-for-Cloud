...
<head>
<title>Data Receiver Profile</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Data Receiver Profile </h2>
		  <p>&nbsp;</p>
...
<table width="576" height="395" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
			...
			<tr>
              <td width="146" height="40" bgcolor="#CCCC00"><span class="style30"> Category </span></td>
            ...
            <tr>
			  <td width="146" height="40" bgcolor="#CCCC00"><span class="style30">Location</span></td>
            ...
            <tr>
              ...
              <td width="222" bgcolor="#CC6600"><span class="style29"> <%out.println(s12);%> </span></td>
            </tr>
            <%
						}
						connection.close();
...
%>		  
	  ...
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          <p class="star style24">Authority Menu</p>
          <div class="clr"></div>
          <ul class="sb_menu">
