    ...
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          ...
          <p align="center" class="style13"><img src="images/Data Owner.jpg" width="425" height="232" /></p>
        </div>
      </div>
      <div class="sidebar">
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          ...
          <ul class="sb_menu style12">
			...
			<li><a href="do_req_enc_key.jsp">Request File Encryption Key Permission and View</a></li>
			<li><a href="do_req_sk.jsp">Request File Secret Key Permission and View</a></li>
