  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Searched Data </h2>
		  <p>&nbsp;</p>
...
try
{
								...
								String sql2="select * from cloud_files ";
							...
							if ((decryptedValues1.contains(keyword)) && (s7.equalsIgnoreCase(category)) )  // searching on 
							{
         ...
         <table width="273" align="center">
            ...
            <div align="center" class="style5 style14"><span class="style11 style12 style8">  <a href="dr_search_data2.jsp?id=<%=i%>&key=<%=keyword%>&rank=<%=UpdateRank%>">View Details </a></span></div>
				...
				<%
							...
							if ((decryptedValues2.contains(keyword)) && (s10.equalsIgnoreCase(category)) )  // searching on 
							{
										
										int UpdateRank1=Integer.parseInt(s18)+1;
         ...
         <table width="273" align="center">
              <tr>
	            <td width="124" height="34" bgcolor="#fc6400"> <div align="left" class="style6 style5 style13 style14 style3 style20 style12 style18 style16 style2">File Name:  </div></td>
			     <td width="137" bgcolor="#fc6400"><span class="style15 style13 style12 style19 style21 style8 style6 style10"><span class="style15 style21 style10 style14 style19 style5 style2 style7"><%=s2%></span></span> </td>
              </tr>
			   
			   <tr>
		         <td width="124" height="36" bgcolor="#fc6400"> <div align="left" class="style6 style5 style13 style14 style3 style20 style12 style18 style2"><span class="style16">Owner Name</span> :  </div></td>
			     <td width="137" bgcolor="#fc6400"><span class="style15 style13 style12 style19 style21 style8 style6 style10"><span class="style15 style21 style10 style14 style19 style5 style2 style7"><%=s3%></span></span> </td>
			   </tr>
		</table>
                <p>
            <div align="center" class="style5 style14"><span class="style11 style12 style8">  <a href="dr_search_data2.jsp?id=<%=i%>&key=<%=keyword%>&rank=<%=UpdateRank1%>">View Details </a></span></div>
                </p>
                <p></p>
				<div>
				  <div align="center">--------------------------------------------------------</div>
				...
				<%
							...
							if ((decryptedValues3.contains(keyword)) && (s13.equalsIgnoreCase(category)) )  // searching on 
							{
										
										int UpdateRank2=Integer.parseInt(s18)+1;
         ...
         <table width="273" align="center">
              <tr>
	            <td width="124" height="34" bgcolor="#fc6400"> <div align="left" class="style6 style5 style13 style14 style3 style20 style12 style18 style16 style2">File Name:  </div></td>
			     <td width="137" bgcolor="#fc6400"><span class="style15 style13 style12 style19 style21 style8 style6 style10"><span class="style15 style21 style10 style14 style19 style5 style7"><%=s2%></span></span> </td>
              </tr>
			   
			   <tr>
		         <td width="124" height="36" bgcolor="#fc6400"> <div align="left" class="style6 style5 style13 style14 style3 style20 style12 style18 style2"><span class="style16">Owner Name</span> :  </div></td>
			     <td width="137" bgcolor="#fc6400"><span class="style15 style13 style12 style19 style21 style8 style6 style10"><span class="style15 style21 style10 style14 style19 style5 style7"><%=s3%></span></span> </td>
			   </tr>
		</table>
                <p>
            <div align="center" class="style5 style14"><span class="style11 style12 style8">  <a href="dr_search_data2.jsp?id=<%=i%>&key=<%=keyword%>&rank=<%=UpdateRank2%>">View Details </a></span></div>
                </p>
                <p></p>
				<div>
				  <div align="center">--------------------------------------------------------</div>
				...
				<%
							...
							if ((decryptedValues4.contains(keyword)) && (s16.equalsIgnoreCase(category)) )  // searching on 
							{
										
										int UpdateRank3=Integer.parseInt(s18)+1;
         ...
         <table width="273" align="center">
              <tr>
			   ...
			   <tr>
                ...
                <p>
            <div align="center" class="style5 style14"><span class="style11 style12 style8">  <a href="dr_search_data2.jsp?id=<%=i%>&key=<%=keyword%>&rank=<%=UpdateRank3%>">View Details </a></span></div>
                </p>
                <p></p>
				<div>
				  <div align="center">--------------------------------------------------------</div>
