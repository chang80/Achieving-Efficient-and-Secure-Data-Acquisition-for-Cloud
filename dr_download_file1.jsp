				    	...
				    	if ( rs1.next() )
					    {
						  ...
						  else
						  {
				    	    ...
				    	    if ( rs2.next() )
					        {
							 ...
							 {
%>							 
<p class="style10"> Decyprtion Permission is Provided </p>
...
<%
							...
							{
							%> 
                            <p align="center" class="style13 style4 style5 style11">Still You Have Not Requested Decryption Permission For This File. </p>
			                <%
							}
