...
try 
	{
		...
		PreparedStatement ps=connection.prepareStatement("insert into cloud_files(fname,ownername,fsize,ct1,mac1,access1,ct2,mac2,access2,ct3,mac3,access3,ct4,mac4,access4,dt,rank) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		ps.setString(1,file);
