...
<head>
<title>Data Receiver Main</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Welcome to Data Receiver Main : <span class="style12"> <%=application.getAttribute("dr")%> </span></h2>
	  ...
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          <p class="star style14">Data Receiver Menu</p>
          <div class="clr"></div>
          <ul class="sb_menu style12">
			...
			<li><strong><a href="dr_dec_req.jsp">Request Decrypt Key from AA</a></strong></li>
			<li><strong><a href="dr_sk_req.jsp">Request Secret Key from AA</a></strong></li>
